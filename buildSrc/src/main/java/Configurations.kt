...
object AndroidX {
    ...
    const val NAVIGATION_FRAGMENT = "androidx.navigation:navigation-fragment:2.3.0"
    const val NAVIGATION_FRAGMENT_KTX = "androidx.navigation:navigation-fragment-ktx:2.3.0"
    const val NAVIGATION_UI = "androidx.navigation:navigation-ui:2.3.0"
